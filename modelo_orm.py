...
class EstructuraBDObras (BaseModel):    
            ...
            direccion = CharField()
            fecha_inicio = DateField(default='12/12/2021')
            fecha_fin_inicial = DateField(default='12/12/2021')
...
#Punto 5
class Obra(EstructuraBDObras):

   
        entorno = CharField()
        nombre = CharField()
        etapa_id = CharField()
        tipo_obra_id = CharField()
        area_responsable_id = CharField()
        descripcion = CharField()
        monto_contrato = IntegerField()
        barrio_id = CharField()
        direccion = CharField()
        ...
        plazo_meses = IntegerField()
        porcentaje_avance = DoubleField(default=0.0)
        empresa_id = CharField()
        licitacion_anio = DateField()
        tipo_contratacion_id = CharField()
        nro_contratacion = CharField()
        beneficiarios = CharField()
        mano_obra = CharField()
        expediente_numero = CharField()
